...
get_addr_fp_t GetAddressingOpLoadStoreT(unsigned int inst) {
    ...
    // So it's sufficient for cytrus to not implement this.
    return nullptr;
}
...
BXJ_INST: {
    ...
    //
    // This is sufficient for cytrus, as the CPU for the 3DS does not implement Jazelle.
